...
@section('page-description', 'Add a new tour package')
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="duration" name="duration" value="{{ old('duration') }}" placeholder="e.g., 3 Days / 2 Nights" required
                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    @error('duration')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" id="group_size" name="group_size" value="{{ old('group_size') }}" placeholder="e.g., Max 12 people" required
                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    @error('group_size')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
            ...
            <div class="mt-6">
                ...
                <textarea id="short_description" name="short_description" rows="2"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('short_description') }}</textarea>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div id="highlights-container">
                <div class="flex items-center space-x-2 mb-2">
                    <input type="text" name="highlights[]" placeholder="Enter a highlight" value="{{ old('highlights.0') }}"
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <textarea id="included" name="included" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('included') }}</textarea>
                    @error('included')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="not_included" name="not_included" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('not_included') }}</textarea>
                    @error('not_included')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="itinerary" name="itinerary" rows="4"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('itinerary') }}</textarea>
                    @error('itinerary')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="requirements" name="requirements" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('requirements') }}</textarea>
                    @error('requirements')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="cancellation_policy" name="cancellation_policy" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('cancellation_policy') }}</textarea>
