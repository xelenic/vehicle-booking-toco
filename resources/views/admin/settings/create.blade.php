    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Create Setting</h1>
                    <p class="mt-2 text-gray-600">Add a new application setting</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8">
            <form action="{{ route('admin.settings.store') }}" method="POST" class="space-y-6">
                ...
                <!-- Value -->
                <div>
                    <label for="value" class="block text-sm font-semibold text-gray-700 mb-2">Default Value</label>
                    <textarea id="value" name="value" rows="3"
                              ...
                              placeholder="Enter the default value for this setting">{{ old('value') }}</textarea>
                    @error('value')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
