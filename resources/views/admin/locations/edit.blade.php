...
@section('page-description', 'Update location information')
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-2xl shadow-lg p-8">
        <div class="mb-6">
            ...
            <p class="text-gray-600">Update the location details below</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="4" 
                              ...
                              placeholder="Enter location description (optional)">{{ old('description', $location->description) }}</textarea>
                    @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="mt-1 text-xs text-gray-500">Uncheck to deactivate this location</p>
                </div>
            </div>
