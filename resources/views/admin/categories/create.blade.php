...
@section('page-description', 'Add a new package category')
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4">
                        <input type="text" id="icon" name="icon" value="{{ old('icon', 'fas fa-tag') }}" placeholder="e.g., fas fa-mountain"
                        ...
                        <div class="w-10 h-10 border border-gray-300 rounded-md flex items-center justify-center bg-gray-50">
                            <i id="icon-preview" class="{{ old('icon', 'fas fa-tag') }} text-gray-600"></i>
                        </div>
                    </div>
