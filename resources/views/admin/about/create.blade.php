...
@section('title', $about ? 'Edit About Page' : 'Create About Page')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">{{ $about ? 'Edit About Page' : 'Create About Page' }}</h1>
                    <p class="mt-2 text-gray-600">{{ $about ? 'Update your about page content' : 'Add a new about page with dynamic content' }}</p>
                </div>
            ...
            <div class="tab-content bg-white rounded-b-2xl shadow-lg p-8" id="content-basic">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="sort_order" name="sort_order" value="{{ old('sort_order', $about->sort_order ?? 0) }}" min="0"
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $about->is_active ?? true) ? 'checked' : '' }}
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            <div id="hero-image-preview" class="mb-4">
                                @if($about && $about->heroMedia)
                                    <img src="{{ $about->heroMedia->url }}" alt="Hero Image" class="h-32 w-32 object-cover rounded-lg">
                                @elseif($about && $about->hero_image)
                                    <img src="{{ asset('storage/' . $about->hero_image) }}" alt="Hero Image" class="h-32 w-32 object-cover rounded-lg">
                                @elseif(old('hero_media_id'))
                                    @php
                                        $media = \App\Models\Media::find(old('hero_media_id'));
                                    @endphp
                                    @if($media)
                                        <img src="{{ $media->url }}" alt="Hero Image" class="h-32 w-32 object-cover rounded-lg">
                                    @endif
                                @endif
                            </div>
                    ...
                    <div>
                        ...
                        <div id="gallery-images-preview" class="mb-4 grid grid-cols-2 gap-4">
                            @if($about && $about->gallery_images_with_urls)
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <div id="statistics-container" class="space-y-4">
                            @if($about && $about->statistics && count($about->statistics) > 0)
            ...
            <div class="tab-content bg-white rounded-b-2xl shadow-lg p-8 hidden" id="content-team">
                ...
                <div>
                    ...
                    <div id="team-container" class="space-y-6">
                        @if($about && $about->team_members && count($about->team_members) > 0)
...
let featureIndex = {{ $about && $about->features ? count($about->features) : 1 }};
let statisticIndex = {{ $about && $about->statistics ? count($about->statistics) : 1 }};
let teamIndex = {{ $about && $about->team_members ? count($about->team_members) : 1 }};
let valueIndex = {{ $about && $about->values ? count($about->values) : 1 }};
